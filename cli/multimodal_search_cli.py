...
def main() -> None:
    ...
    search_parser = subparsers.add_parser("image_search", help="Search documents using an imageImage")
    search_parser.add_argument("image", type=str, help="Path to image fileImage")
