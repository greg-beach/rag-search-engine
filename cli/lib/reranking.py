...
def llm_rerank_individual(query: str, documents: list[dict], limit: int = DEFAULT_SEARCH_LIMIT) -> list[dict]:
    scored_docs = []
...
def llm_rerank_batch(query: str, documents: list[dict], limit: int = DEFAULT_SEARCH_LIMIT) -> list[dict]:
    if not documents:
        return []
...
def cross_encoder_rerank(query: str, documents: list[dict], limit: int = DEFAULT_SEARCH_LIMIT) -> list[dict]:
    pairs = []
    for doc in documents:
