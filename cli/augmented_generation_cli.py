...
def main():
    ...
    summarize_parser = subparsers.add_parser("summarize", help="Search query for summarization")
    ...
    citations_parser = subparsers.add_parser("citations", help="Generate answer with citations")
